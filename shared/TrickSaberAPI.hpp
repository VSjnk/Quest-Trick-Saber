...
namespace TrickSaber {
    ...
    public:
        ...
        static std::optional<TrickSaber::TrickState> getThrowState(GlobalNamespace::SaberType saberType) noexcept {
            auto function = CondDep::Find<TrickSaber::TrickState, GlobalNamespace::SaberType>(modId, "getThrowState");
        ...
        static std::optional<TrickSaber::TrickState> getSpinState(GlobalNamespace::SaberType saberType) noexcept {
            auto function = CondDep::Find<TrickSaber::TrickState, GlobalNamespace::SaberType>(modId, "getSpinState");
        ...
        static std::optional<UnityEngine::GameObject*> getActiveSaber(int saberType) noexcept {
            auto function = CondDep::Find<UnityEngine::GameObject*, GlobalNamespace::SaberType>(modId, "getActiveSaber");
        ...
        static std::optional<UnityEngine::GameObject*> getTrickSaber(int saberType) noexcept {
            auto function = CondDep::Find<UnityEngine::GameObject*, GlobalNamespace::SaberType>(modId, "getTrickSaber");
        ...
        static std::optional<UnityEngine::GameObject*> getNormalSaber(int saberType) noexcept {
            auto function = CondDep::Find<UnityEngine::GameObject*, GlobalNamespace::SaberType>(modId, "getNormalSaber");
